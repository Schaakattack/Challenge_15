...
def get_recommendation(risk_level):
    """
    returns reccomended portfolio off of risk
    """
    ...
    elif risk_level == "MOON":
        recommend = "40% (ETH), 40% (BTC), 20% (GME)"
    else:
...
def recommend_portfolio(intent_request):
 ...
 # YOUR CODE GOES HERE!
    if source == 'DialogCodeHook':
        ...
        #below code validates age, investment amount and risk tolerance if request is valid 
        ...
        if not validation_result['isValid']:
            ...
            return elicit_slot(
                intent_request['sesionAttributes'],
    ...
    return close(
        ...
        'Fulfilled',
        {
            ...
            'content': """{} thanks for submitting your information.  Based on what you told me,
            I suggest you choose and investment portfolio that has {}""".format(first_name, initial_recommendation)'
        }
    )
